...
public class FlightDao {
    ...
    private static final String SELECT_FLIGHT_BY_ID = "select flightId ,flightName ,flightNumber ,destination , noOfStops  from flight where flightId =?";
    ...
    private static final String UPDATE_Flight_SQL = "update flight set flightName = ?,flightNo= ?, destination =?, noOfStops  where flightId = ?;";
...
//                String noOfStops = rs.getString("noOfStops");
    ...
    public Flight selectFlight(int flightId) {
        ...
        try (Connection connection = getConnection();
            ...
            while (rs.next()) {
                ...
                flight = new Flight(flightName, flightNumber, destination, noOfStops);
            }
        } catch (SQLException e) {
            printSQLException(e);
        }
    ...
    public boolean updateFlight(Flight flight) throws SQLException {
        ...
        try (Connection connection = getConnection(); PreparedStatement statement = connection.prepareStatement(UPDATE_Flight_SQL);) {
            ...
            statement.setString(3, flight.getNoOfStops());
            statement.setInt(4, flight.getFlightId());
