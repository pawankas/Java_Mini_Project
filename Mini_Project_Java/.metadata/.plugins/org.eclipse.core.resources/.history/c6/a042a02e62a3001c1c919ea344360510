...
//                    break;
    ...
    throws SQLException, IOException {
        ...
        Flight newFlight = new Flight(flightName, flightNumber, destination, noOfStops);
    ...
    throws SQLException, IOException {
        ...
        Flight flight = new Flight(flightId, flightName, flightNumber, destination, noOfStops);
